...
/*
 * $Id: Groove.java 5758 2015-12-06 15:55:03Z rensink $
 */
package groove.util;
...
public class Groove {
     ...
     *         formatted
     */
    static public UnfoldingGrammarModel loadGrammar(String dirname) throws IOException {
        File dir = new File(GRAMMAR.addExtension(dirname));
        return UnfoldingGrammarModel.newInstance(dir);
    }
