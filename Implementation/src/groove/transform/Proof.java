...
public class Proof {
    ...
    private final Collection<Proof> subProofs = new java.util.LinkedHashSet<Proof>();
    ...
    /**
     * Unfolding extension below
     */

    LinkedHashMap<HostEdge,Proof> consumedElementsMap = new LinkedHashMap<HostEdge,Proof>();

    public Map<HostEdge,Proof> getConsumedElementsMap() {
        return this.consumedElementsMap;
    }
